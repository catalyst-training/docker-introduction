...
* <!-- .element: class="fragment" data-fragment-index="0" -->An image is an ordered set of **read only** archive files
* <!-- .element: class="fragment" data-fragment-index="1" -->Each file generated by executing some command
    ...
    * <!-- .element: class="fragment" data-fragment-index="4" -->run some script
       ...
       ```
* <!-- .element: class="fragment" data-fragment-index="5" -->These files are called _intermediate images_ or _layers_
* <!-- .element: class="fragment" data-fragment-index="6" -->Child images build upon base images
...
* <!-- .element: class="fragment" data-fragment-index="0" -->Initialise building stage and set *base image*
   ``` Dockerfile
   FROM <base image>
   ```
* Instructions for building the image <!-- .element: class="fragment" data-fragment-index="1" -->
   ...
   RUN make /app
   ```
* <!-- .element: class="fragment" data-fragment-index="3" -->Control Docker behaviour when you type `docker run...`
   ```dockerfile
   EXPOSE 5000
   VOLUME /var/www/data
...
<!-- .element: class="fragment" data-fragment-index="1" -->See official reference [documentation](https://docs.docker.com/engine/reference/builder/)  for more
